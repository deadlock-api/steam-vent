...
impl ::steam_vent_proto_common::protobuf::Message for CMsgSteamDatagramSignedMessageGeneric {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.dummy_pad.as_ref() {
            my_size += ::steam_vent_proto_common::protobuf::rt::bytes_size(1023, &v);
        }
        my_size += ::steam_vent_proto_common::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
...
pub struct CMsgSteamDatagramConnectRequest {
    ...
    pub crypt: ::steam_vent_proto_common::protobuf::MessageField<super::steamnetworkingsockets_messages::CMsgSteamDatagramSessionCryptInfoSigned>,
...
pub struct CMsgSteamDatagramConnectionClosed {
    ...
    pub quality_relay: ::steam_vent_proto_common::protobuf::MessageField<super::steamnetworkingsockets_messages::CMsgSteamDatagramConnectionQuality>,
    // @@protoc_insertion_point(field:CMsgSteamDatagramConnectionClosed.quality_e2e)
    pub quality_e2e: ::steam_vent_proto_common::protobuf::MessageField<super::steamnetworkingsockets_messages::CMsgSteamDatagramConnectionQuality>,
...
pub struct CMsgSteamDatagramGameserverSessionRequest {
    ...
    pub dev_client_cert: ::steam_vent_proto_common::protobuf::MessageField<super::steamnetworkingsockets_messages_certs::CMsgSteamDatagramCertificateSigned>,
    // special fields
...
impl ::steam_vent_proto_common::protobuf::Message for CMsgSteamDatagramGameserverSessionRequest {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                810 => {
                    ::steam_vent_proto_common::protobuf::rt::read_singular_message_into_field(is, &mut self.dev_client_cert)?;
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.dev_gameserver_identity.as_ref() {
            my_size += ::steam_vent_proto_common::protobuf::rt::string_size(100, &v);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::steam_vent_proto_common::protobuf::CodedOutputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        ...
        if let Some(v) = self.dev_client_cert.as_ref() {
            ::steam_vent_proto_common::protobuf::rt::write_message_field_with_cached_size(101, v, os)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn default_instance() -> &'static CMsgSteamDatagramGameserverSessionRequest {
        static instance: CMsgSteamDatagramGameserverSessionRequest = CMsgSteamDatagramGameserverSessionRequest {
            ...
            dev_client_cert: ::steam_vent_proto_common::protobuf::MessageField::none(),
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub mod cmsg_steam_datagram_p2psession_request_body {
    ...
    impl<'a> ::std::default::Default for &'a EncryptedData {
        fn default() -> &'a EncryptedData {
            <EncryptedData as ::steam_vent_proto_common::protobuf::Message>::default_instance()
        }
    }
    ...
    impl ::steam_vent_proto_common::protobuf::Message for EncryptedData {
