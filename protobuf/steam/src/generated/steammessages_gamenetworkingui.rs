...
pub struct CGameNetworkingUI_ConnectionState {
    ...
    pub e2e_quality_local: ::steam_vent_proto_common::protobuf::MessageField<super::steamnetworkingsockets_messages::CMsgSteamDatagramConnectionQuality>,
    // @@protoc_insertion_point(field:CGameNetworkingUI_ConnectionState.e2e_quality_remote)
    pub e2e_quality_remote: ::steam_vent_proto_common::protobuf::MessageField<super::steamnetworkingsockets_messages::CMsgSteamDatagramConnectionQuality>,
    ...
    pub front_quality_local: ::steam_vent_proto_common::protobuf::MessageField<super::steamnetworkingsockets_messages::CMsgSteamDatagramConnectionQuality>,
    // @@protoc_insertion_point(field:CGameNetworkingUI_ConnectionState.front_quality_remote)
    pub front_quality_remote: ::steam_vent_proto_common::protobuf::MessageField<super::steamnetworkingsockets_messages::CMsgSteamDatagramConnectionQuality>,
...
impl<'a> ::std::default::Default for &'a CGameNetworkingUI_ConnectionSummary {
    fn default() -> &'a CGameNetworkingUI_ConnectionSummary {
        <CGameNetworkingUI_ConnectionSummary as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CGameNetworkingUI_ConnectionSummary {
...
pub struct CGameNetworkingUI_AppSummary {
    ...
    pub main_cxn: ::steam_vent_proto_common::protobuf::MessageField<CGameNetworkingUI_ConnectionSummary>,
    // special fields
...
impl<'a> ::std::default::Default for &'a CGameNetworkingUI_AppSummary {
    fn default() -> &'a CGameNetworkingUI_AppSummary {
        <CGameNetworkingUI_AppSummary as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CGameNetworkingUI_AppSummary {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                242 => {
                    ::steam_vent_proto_common::protobuf::rt::read_singular_message_into_field(is, &mut self.main_cxn)?;
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn default_instance() -> &'static CGameNetworkingUI_AppSummary {
        static instance: CGameNetworkingUI_AppSummary = CGameNetworkingUI_AppSummary {
            ...
            main_cxn: ::steam_vent_proto_common::protobuf::MessageField::none(),
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl ::steam_vent_proto_common::RpcMessage for CGameNetworkingUI_ConnectionSummary {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage for CGameNetworkingUI_AppSummary {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
